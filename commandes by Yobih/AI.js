const { Yobih-MD } = require('../framework/zokou');
...
Yobih-MD({nomCom:"tkm",reaction:"📡",categorie:"Ai"},async(dest,zk,commandeOptions)=>{
...
.catch(error => {
  ...
  Yobih-MD({ nomCom: "dalle", reaction: "📡", categorie: "Ai" }, async (dest, zk, commandeOptions) => {
  ...
  Yobih-MD({ nomCom: "gpt", reaction: "📡", categorie: "Ai" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
